/**
 * Driver bidding project API
 * This is a simple API for the bidding project.
 *
 * OpenAPI spec version: 1.0.0
 * Contact: dev.karthi@outlook.com
 *
...
object DevelopersApi {
  ...
  def searchInventory(searchString: Option[String] = None, skip: Option[Int] = None, limit: Option[Int] = None): ApiRequest[Seq[InventoryItem]] =
    ApiRequest[Seq[InventoryItem]](ApiMethods.GET, "https://virtserver.swaggerhub.com/karthijsdev/bidding-proj/1.0.0", "/inventory", "application/json")
